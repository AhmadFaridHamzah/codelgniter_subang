<?php
$atb=array('class'=>'form-horizontal','id'=>'addemployesform','data-toggle'=>'validator');
echo form_open('admin/admincontrol/add_employees_prosse',$atb);
?>
...
<div class="form-group <?php if(form_error('firstName')){ echo 'has-error';}?>">
  ...
  <div class="col-md-4">
   ...
   $inputfirstName=array(
    ...
    echo form_error('firstName','<p class="help_block with-errors">','</p>');
